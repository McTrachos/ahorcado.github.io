...
function dibujarLinea(ix,iy,fx,fy,color) {
 ...
 function mensaje(estado) {
    if(estado){
      dibujarLetra("¡GAMASTE",ancho*0.35,alto*0.25,"1em 'Inter', sans-serif","#0A3871");
    }
    else{
      dibujarLetra("¡PERDISTE!",ancho*0.35,alto*0.25,"1em 'Inter', sans-serif","#0A3871");
    }
 }
 ...
 function dibujarLetraIncorrecta(letra,posicion){
   ...
   dibujarLetra(letra, (inicio + (espacio * posicion)),alto * 0.94,"3em 'Inter', sans-serif","#0A3871");
 }